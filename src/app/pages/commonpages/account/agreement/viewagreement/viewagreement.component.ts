...
@Component({
  selector: 'app-viewagreement',
  templateUrl: './viewagreement.component.html',
  styleUrls: ['./viewagreement.component.css']
})
export class ViewagreementComponent implements OnInit {
  ...
  textenable(i,event:any)
  {
    ...
    //console.log(i,this.values,'event',event,'ticket',$("#hr"+i).val());
  }
