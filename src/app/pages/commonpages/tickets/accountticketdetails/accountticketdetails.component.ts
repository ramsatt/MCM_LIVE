...
@Component({
  selector: 'app-accountticketdetails',
  templateUrl: './accountticketdetails.component.html',
  styleUrls: ['./accountticketdetails.component.scss']
})
export class AccountticketdetailsComponent implements OnInit, OnChanges {
    @Input() TicketID;
