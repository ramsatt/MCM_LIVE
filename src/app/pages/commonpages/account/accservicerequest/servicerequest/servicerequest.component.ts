...
export class ServicerequestComponent implements OnInit, OnChanges {
  ...
  PDF_PATH: any = '';
    ...
    constructor(private domSanitizer: DomSanitizer, private fb: FormBuilder, public modelService: ModelsService, public asrmService: AsrmService, public menu: MenumanagementService, private _sanitizer: DomSanitizer) {
  ...
  public Show_ACC_KI_Edit_Modal(KI_ID) {
  ...
  public Show_Acc_SOM_Create_Modal() {
      if (this.kiScltID === '') {
          $.notify({
  ...
  public Show_Acc_Sol_Edit_Modal(SOL_ID) {
  ...
  public Show_ASR_Assign_Part_Modal() {
      if (this.solScltID === '') {
          $.notify({
  ...
  public Show_ASR_INS_Create_Modal() {
      if (this.solScltID === '') {
          $.notify({
              title: '<strong>Troubleshoot Not Selected.</strong><br>',
              message: 'Please select a Troubleshoot.'
  ...
  public Show_ASR_INS_Edit_Modal(ins_ID) {
  ...
  public Show_ASR_INS_PDF_Create_Modal() {
      if (this.solScltID === '') {
          $.notify({
              title: '<strong>Troubleshoot Not Selected.</strong><br>',
              message: 'Please select a Troubleshoot.'
  ...
  public Show_ASR_INS_PDF_Edit_Modal(insPDF_ID) {
  ...
  public Delete_Acc_INS_PDF(IPDF_ID) {
      const formData = new FormData();
      formData.append('asomID', this.solScltID);
  ...
  public Show_ASR_GEN_INS_PDF_Create_Modal() {
      if (this.solScltID === '') {
          $.notify({
              title: '<strong>Troubleshoot Not Selected.</strong><br>',
              message: 'Please select a Troubleshoot.'
  ...
  public Show_ASR_GEN_INS_PDF_Edit_modal(GPDF_ID) {
  ...
  public Delete_Acc_GEN_INS_PDF(GPDF_ID) {
      const formData = new FormData();
      formData.append('asomID', this.solScltID);
